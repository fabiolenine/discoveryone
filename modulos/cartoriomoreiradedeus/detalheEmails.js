module.exports = function(sendgridemails){
	...
	var contatointerno = function(nome, email, assunto, mensagem, lat, loc, situacao, callback){
	...
	var contatocliente = function(nome, email, assunto, mensagem, lat, loc, situacao, callback){
		var params = {to: 		email,
					  from:		'ola@cartoriomoreiradedeus.not.br',
					  fromname: 'Cartório Moreira de Deus',
					  subject:	assunto,
