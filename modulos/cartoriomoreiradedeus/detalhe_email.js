module.exports = function(nodemailer){
	...
	var enviaremail = function(nome, email, assunto, mensagem, 
		...
		var mailOptions = {
			...
			to: 		'monica@cartoriomoreiradedeus.not.br, fatima@cartoriomoreiradedeus.not.br',	// list of receivers
		...
		var transporter = nodemailer.createTransport("SMTP",accountmail);
